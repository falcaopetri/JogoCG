 ...
 *
 * <p>
 * Currently supports AL_EXT_EFX version 1.0 effects and filters.</p>
 *
...
public final class EFXUtil {
    ...
    /**
     * Tests OpenAL to see whether the specified effect type is supported. This
     * is done by creating an effect of the specified type. If creation succeeds
     * the effect is supported.
     *
    ...
    /**
     * Tests OpenAL to see whether the specified filter type is supported. This
     * is done by creating a filter of the specified type. If creation succeeds
    ...
    /**
     * Generic test function to see if an EFX object supports a specified kind
     * of type. Works for effects and filters.
     *
     * @param objectType Type of object to test. Must be either EFXUtil.EFFECT
     * or EFXUtil.FILTER.
     * @param typeValue OpenAL type the object should be tested for support,
     * e.g. AL_FILTER_LOWPASS or AL_EFFECT_REVERB.
     *
